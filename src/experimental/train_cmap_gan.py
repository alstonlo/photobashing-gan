...
from src.gan.gan import PhotobashingGAN
...
def main():
    ...
    gan = PhotobashingGAN(epochs=args.epochs, lr=args.lr, lamb=args.lamb)

    # logging
    results_dir = pathlib.Path(__file__).parents[2] / "results"
    logger = WandbLogger(project="cmap_gan", log_model="all", save_dir=str(results_dir))
